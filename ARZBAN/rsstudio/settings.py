"""
Django settings for rsstudio project.
...
# The fallback below exists only so `runserver` works out of the box.
...
# Defaults to True for local development; set DJANGO_DEBUG=False to disable.
DEBUG = os.environ.get('DJANGO_DEBUG', 'True').lower() not in ('false', '0', 'no')

# Comma-separated list, e.g. DJANGO_ALLOWED_HOSTS="example.com,192.168.1.10"
ALLOWED_HOSTS = [
    h.strip()
...
WSGI_APPLICATION = 'rsstudio.wsgi.application'
